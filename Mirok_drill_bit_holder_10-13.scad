...
drill_bit_wall=7;
drill_bit_screw_hole_diameter=6;
...
//***cylyndrical holes for each bit size
 cylinder(h = drill_bit_holes_depth, r = 2*tolerance + (indexX + text_x_first_number + 1 - indexY/10)/2, center = true);
...
signs_text_offset=[(drill_bit_square_hole_X+drill_bit_wall)/2,0,drill_bit_holes_depth];
// signs in holes
...
signs=signs_10_13; //See  <Mirok_drill_bit_holder_signs.scad> for signs content
