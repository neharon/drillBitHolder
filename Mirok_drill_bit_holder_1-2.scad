...
signs=signs_1_2; //See  <Mirok_drill_bit_holder_signs.scad> for signs content
//signs text param
signs_text_size = 5;
// signs on top of plate
signs_text_offset=[ - drill_bit_square_hole_X*3/4,-drill_bit_square_hole_Y/2-drill_bit_wall + min(drill_bit_square_hole_X,drill_bit_square_hole_Y),0];
// signs in holes
